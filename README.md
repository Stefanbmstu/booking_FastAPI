# Бронирование отелей
Это репозиторий к учебному веб-сервису по бронированию отелей в ходе бэкенд разработки на Python с упором на изучение FastAPI и работу с SQLAlchemy, Celery, Redis, Docker, а также многими другими библиотеками и технологиями.
