# Бронирование отелей
Это репозиторий к веб-сервису по бронированию отелей в ходе изучения бэкенд разработки на Python с упором на изучение FastAPI и работу с SQLAlchemy, Celery, Redis, Docker, а также многими другими библиотеками и технологиями.
...
## Обратная связь
Любые комментарии, исправления, замечания пишите мне в [телеграм](https://t.me/stefanmr).
